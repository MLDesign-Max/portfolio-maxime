...
export default function MentionsLegales() {
  return (
    <main className="relative min-h-screen bg-bg-page text-text-default pt-24 pb-20 px-6 isolate">
      {/* Grille de fond pour la continuité visuelle avec le reste du site */}
      <div
        aria-hidden
      ...
      <div className="max-w-3xl mx-auto w-full space-y-10">
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-2 font-mono text-sm text-[#D4D4D4] hover:text-white transition-colors"
        >
        ...
        <div className="space-y-10 text-[#D4D4D4] text-sm sm:text-base leading-relaxed">
          {/* 1. Éditeur du site */}
          <section className="space-y-3">
            <h2 className="text-xl font-semibold text-white">1. Éditeur du site</h2>
            <p>
              Le site <strong className="text-white">maximelussiana.fr</strong> est édité par :
            </p>
          ...
          <section className="space-y-3">
            ...
            <p>
              Le site est hébergé par la société <strong className="text-white">Vercel Inc.</strong> :
            </p>
            <p>
              ...
              <a
                ...
                className="text-[#1258f6] hover:underline"
              >
                https://vercel.com
              </a>
            </p>
